      ...
      >
        ...
        <template #body="props">
          <q-tr :props="props">
            ...
            >
              <div v-if="c.name != 'actions' && c.name != 'ot'">
...
<style lang="scss" scoped>
  ...
  .frozen-column.first {
    left: 0;
    z-index: 3;
    /* Ensure this column is on top of the other frozen columns */
    width: 160px;
  }
  ...
  .frozen-column.second {
    ...
    z-index: 2;
    /* Ensure this column is below the first frozen column */
  }

  .frozen-column.third {
    left: 320px;
    /* Adjust this based on the width of the first two columns */
    z-index: 1;
    /* Ensure this column is below the first two frozen columns */
